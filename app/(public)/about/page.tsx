				...
				<section className='mb-16'>
					...
					<div className='bg-white rounded-lg p-8 shadow-sm border border-gray-200'>
						<p className='text-gray-700 leading-relaxed mb-4'>
							Đồ án "Ứng dụng Web App để Học Tập và Ôn Luyện Tiếng Nhật" được phát
							triển nhằm giải quyết bài toán thực tế về nhu cầu học ngoại ngữ ngày càng
							tăng cao, đặc biệt là tiếng Nhật - một trong những ngôn ngữ được quan tâm
							hàng đầu tại Việt Nam.
						</p>
						<p className='text-gray-700 leading-relaxed mb-4'>
							Thông qua việc ứng dụng các công nghệ web hiện đại kết hợp với các phương
							pháp sư phạm khoa học, đồ án hướng tới việc xây dựng một nền tảng học tập
							trực tuyến hiệu quả, tiện lợi và phù hợp với người học Việt Nam.
						</p>
					</div>
				</section>
	...
	return (
		<div className='bg-white rounded-lg p-6 shadow-sm border border-gray-200'>
			<div className='flex gap-6'>
				<div
					className={`flex-shrink-0 w-16 h-16 bg-gradient-to-br ${color} rounded-lg flex items-center justify-center text-white font-bold text-xl`}
				>
					{number}
				</div>
