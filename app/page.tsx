        ...
        <div className="relative container mx-auto px-4 py-20 md:py-32">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-600 mb-10 max-w-2xl mx-auto">
              Học tiếng Nhật nhanh chóng và hiệu quả với phương pháp độc quyền.
              Từ N5 đến N1, chúng tôi đồng hành cùng bạn!
            </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => {
              ...
              return (
                <div
                  key={index}
                  className="group p-6 bg-slate-50 rounded-2xl hover:shadow-xl hover:-translate-y-2 transition-all duration-300 cursor-pointer"
                >
                  <div
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {levels.map((level, index) => (
              <div
                key={index}
                className="group bg-white rounded-2xl p-8 border-2 border-slate-200 hover:border-blue-500 hover:shadow-2xl transition-all duration-300 cursor-pointer"
              >
                <div className="flex items-center justify-between mb-4">
                  <Award className="w-12 h-12 text-blue-600 group-hover:scale-110 transition-transform" />
                  <TrendingUp className="w-6 h-6 text-slate-400" />
                </div>
                <h3 className="text-2xl font-bold text-slate-800 mb-2">
                  {level.title}
                </h3>
                <p className="text-slate-600 mb-6">{level.description}</p>
                ...
                <button className="w-full py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl font-semibold hover:shadow-lg transition-all duration-200">
                  Bắt đầu học
                </button>
              </div>
            ))}
